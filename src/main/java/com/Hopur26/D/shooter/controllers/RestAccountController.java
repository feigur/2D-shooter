...
public class RestAccountController {
    ...
    @RequestMapping("/account/unsetadmin")
    public Account notadmin(@RequestParam(value="username", defaultValue = "") String username){
        Account exist = accountService.findByUsername(username);
        if(exist != null){
    ...
    public Account adminunmute(@RequestParam(value="username", defaultValue = "") String username,
                         @RequestParam(value="mute", defaultValue = "") String mute){
        Account exist = accountService.findByUsername(username);
        if(exist != null){
            boolean admin = exist.getAdmin();
